"""Disabled legacy OpenAI group reviewer compatibility wrapper.

Actual OpenAI execution is centralized in
...
def review_group(
    ...
    """Return a disabled no-call result for the retired group-review path.
