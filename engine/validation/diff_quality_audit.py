...
def audit_last_patch_diff_with_openai() -> dict:
    ...
    audit_event = {
        ...
        "audited_changed_fields": prompt_payload.get("exact_changed_fields", {}),
        "variant_count_before": prompt_payload.get("variant_count_before"),
        "variant_count_after": prompt_payload.get("variant_count_after"),
